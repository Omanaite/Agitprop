  ...
  return (
    <section className="admin-card p-6 md:p-7">
      ...
      <p className="admin-muted mt-2 text-sm leading-6">
        Configure payout references and operation mode for Stripe and PayPal.
        For sandbox testing, keep mode on <strong>test</strong>.
      </p>
      ...
      {errors.length ? (
        <ul className="mt-3 space-y-1 text-sm text-[var(--admin-danger)]">
          {errors.map((error) => (
